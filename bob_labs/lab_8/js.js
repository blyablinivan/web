...
let emp12 = new Designer("Valeriy1 ", "Zalyzhniy", 1000, 11, 0.8);
let emp11 = new Designer("Valeriy2 ", "Zalyzhniy", 1000, 11, 0.8);
let emp5 = new Developer("Valeriy3 ", "Zalyzhniy", 1000, 11);
let emp6 = new Developer("Valeriy4 ", "Zalyzhniy", 1000, 11);
let emp7 = new Developer("Valeriy5 ", "Zalyzhniy", 1000, 11);
let emp8 = new Designer("Valeriy6 ", "Zalyzhniy", 1000, 11, 0.8);
let emp9 = new Designer("Valeriy7 ", "Zalyzhniy", 1000, 11, 0.8);
let emp10 = new Developer("Valeriy8 ", "Zalyzhniy", 1000, 11);
let emp2 = new Developer("Adam ", "Link", 1500, 5);
let emp4 = new Developer("Vernand ", "Nihao", 1300, 6);
let emp13 = new Developer("Vernand ", "Nihao", 1300, 6);
let emp3 = new Manager("Vova ", "Zelya", 2000, 8, [emp13,emp11, emp2, emp4, emp10, emp9, emp8, emp7, emp6, emp5, emp12]);
